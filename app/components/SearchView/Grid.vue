<template>
  <ul class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
    <li v-for="specimen in specimens" :key="specimen.self" class="flex relative bg-base-57 rounded-md border border-base-57 justify-center items-center aspect-square">
      <SpecimenImageCarousel :specimen class="peer" />
      <div class="absolute w-full bottom-0 bg-base-77/85 p-4 sm:px-3 sm:py-2 md:px-3 md:py-1.5 lg:p-4 xl:p-2 flex peer-hover:hidden flex-col">
