<template>
  <div :class="['rounded-md py-2 space-y-2 flex flex-col', { 'flex-none': collapsed }]">
    <button @click.prevent.stop="collapsed = !collapsed" class="inline-flex text-base-27 dark:text-base-77 hover:text-accent-26 dark:hover:text-accent-36 items-center justify-between w-full cursor-pointer pb-1 border-b border-base-57 dark:border-base-27">
