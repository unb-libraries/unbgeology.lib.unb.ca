<template>
  <div :class="['bg-primary-20 dark:bg-primary-60 py-2 px-4 space-y-2 divide-y divide-primary-40 overflow-y-hidden flex flex-col', { 'flex-none': collapsed }]">
    ...
    <div v-show="!collapsed" class="py-2 grow overflow-y-hidden">
