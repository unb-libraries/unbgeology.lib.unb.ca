      ...
      <div class="flex gap-x-12">
        <article v-for="category in ['fossil', 'mineral', 'rock']" class="flex flex-col gap-y-6 w-1/3">
          ...
          <div class="flex flex-col space-y-4">
            ...
            <a :href="`/browse/${category}`" class="text-accent-26 dark:text-accent-36 text-lg font-semibold hover:underline border-none rounded-md">Browse {{ category.charAt(0).toUpperCase() + category.slice(1) }}s</a>
          </div>
        </article>
      </div>
    </section>
